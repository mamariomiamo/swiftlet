...
namespace PX4FSM
{
    ...
    private:
        ...
        quadrotor_msgs::TrajectoryPoint traj_sp_enu_;
    ...
    private:
        ...
        void TrajectoryPointCallback(const quadrotor_msgs::TrajectoryPoint::ConstPtr &traj_pt);
